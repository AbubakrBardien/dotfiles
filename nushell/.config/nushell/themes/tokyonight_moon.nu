...
let scheme = {
	...
	command: "#65bcff"
	punctuation: "#828bb8"
	variable: { fg: "#c099ff" attr: i }
	string: "#c3e88d"
}

$env.config.color_config = {
	leading_trailing_space_bg: { fg: "#89ddff" attr: "u" }

	separator: { fg: "#2f334d" }
	header: { fg: "#c8d3f5" attr: b }
	row_index: { fg: "#545c7e" }
	hints: $scheme.virtual_text
	
	search_result: { fg: "#222436" bg: "#ff966c" }
	
	shape_internalcall: $scheme.command
	shape_external: $scheme.command
	shape_keyword: $scheme.command
	shape_flag: $scheme.blue
	shape_closure: $scheme.blue

	shape_table: $scheme.punctuation
	shape_list: $scheme.punctuation
	shape_record: $scheme.punctuation
	shape_block: $scheme.punctuation
