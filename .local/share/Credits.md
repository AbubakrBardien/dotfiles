...
Big thanks to the folloing people:

Relatively small scripts I either copied, copied and modified, or just took insperation from.

| Person | Their Script | Video Link | My Version |
| ------ | ------------ | ---------- | ---------- |
...
And special thanks to [PrimaMateria](https://github.com/PrimaMateria) for developing a minimal browser startpage template:

Brief Explaination: https://primamateria.github.io/blog/startpages \
GitHub Repo Template: https://github.com/PrimaMateria/startpages-template
