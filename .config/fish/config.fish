...
#set -xg CARGO_HOME "$XDG_DATA_HOME/cargo" # I can't figure out how to modify a path related to this in $PATH
...
function add_path # Adds a path to the $PATH variable
	contains -- $argv $fish_user_paths
		or set -U fish_user_paths $fish_user_paths $argv
	echo "Updated PATH: $PATH"
end

function remove_path # Removes a path from the $PATH variable
