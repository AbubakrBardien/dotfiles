...
local function find_and_add_entries()
	...
	local files = {}
	scan_dir(autoloaded_dir, path, o.directory_mode or mp.get_property("directory-mode", "lazy"), mp.get_property_native("platform") == "windows" and "\\" or "/", 0, files, extensions)
